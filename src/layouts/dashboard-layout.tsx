  ...
  return (
    <Box as="section" h="100vh" overflowY="auto">
      ...
      <Box py="8" textAlign="center">
        <Link href={`/organizations/${user.data?.organizationId}`}>View Public Organization Page</Link>
      </Box>
    </Box>
  );
};
      ...
      <Container maxW="container.lg" size="3xl" py="3">
        <Flex justify="space-between">
          <HStack>
            ...
            <HStack spacing="1">
              <Link icon={<InfoOutlineIcon />} variant="solid" href="/dashboard/jobs">
                Jobs
              </Link>
            </HStack>
          </HStack>
          <HStack>
            <Button variant="outline" onClick={() => console.log('Logging Out...')}>
              Log Out
            </Button>
          </HStack>
        </Flex>
