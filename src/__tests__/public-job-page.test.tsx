import PublicJobPage, { getServerSideProps } from '@/pages/organizations/[organizationId]/jobs/[jobId]';
...
describe('Public Job Page', () => {
  ...
  it('should render the not found message if the data does not exist', async () => {
    const { rerender } = appRender(<PublicJobPage organization={null} job={null} />);
    ...
    rerender(<PublicJobPage organization={organization} job={{ ...job, organizationId: '123' }} />);
